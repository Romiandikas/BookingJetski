...
public class UserViewHolder extends RecyclerView.ViewHolder{
    ...
    public UserViewHolder(@NonNull View itemView){
        ...
        txtModeljetski = itemView.findViewById(R.id.txtServiceList);
    ...
    private void alertAction(Context context,int position) {
        ...
        modeljetski = userList.get(position).getModeljetski();
            ...
            public void onClick(DialogInterface dialog, int i) {
                switch (i){
                    case 0:
                        ...
                        viewActivity.putExtra("modeljetski", modeljetski);
                    ...
                    case 1:
                        ...
                        modifyActivity.putExtra("modeljetski", modeljetski);
